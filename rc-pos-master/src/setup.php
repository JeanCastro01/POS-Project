...
<html lang="en">
    ...
    <head>
        ...
        <title>CCT-POS - Installation</title>
            ...
            <div class="card card-register mx-auto mt-5">
                ...
                <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    <div class="form-label-group">
                                        <input type="text" id="hostName" class="form-control"
                                            placeholder="Enter hostname here" required="required" autofocus="autofocus">
                                ...
                                <div class="col-md-6">
                                    <div class="form-label-group">
                                        <input type="text" id="dbUser" class="form-control"
                                            placeholder="Enter name of your Database User" required="required"
                                            autofocus="autofocus">
                        ...
                        <div class="form-group">
                            <div class="form-label-group">
                                <input type="text" id="storeName" class="form-control"
                                    placeholder="Enter your store name" required="required">
                    ...
                    <div class="text-center">
                        <br>
                        Not sure what to do? <a class="d-block small" href="https://github.com/vruqa/rc-pos/">Contact
                            developers</a>
                    </div>
                </div>
            </div>
