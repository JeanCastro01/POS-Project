            ...
            <form class="">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="" value="" placeholder="Enter last name here..."
                            required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="" value="" placeholder="Enter role here..."
                            required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="" value="" placeholder="Enter username here..."
                            required>
